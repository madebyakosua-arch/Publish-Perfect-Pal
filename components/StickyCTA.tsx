...
export const StickyCTA: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] z-40 p-3 sm:p-4 animate-in slide-in-from-bottom duration-300">
