...
export const FAQ: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-20 bg-brand-500">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {FAQS.map((faq) => (
            <div key={faq.id} className="rounded-lg overflow-hidden shadow-md">
              <button 
              ...
              >
                <div className="px-6 pb-6 pt-0 text-slate-600 leading-relaxed border-t border-slate-100 bg-white">
